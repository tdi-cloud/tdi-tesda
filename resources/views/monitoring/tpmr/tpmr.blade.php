...
<script>
  // ---------- Reference Data ----------
  const REGIONS = [
    { id: 'NCR',   name: 'National Capital Region', admin: 'Dir. Angelina M. Carreon' },
    { id: 'R1', name: 'Ilocos Region',           admin: 'Dir. Ramon Evan T. Ruiz' },
    { id: 'R2', name: 'Cagayan Valley Region',           admin: 'Dir. Ashary A. Banto' },
    { id: 'R3',   name: 'Central Luzon',                  admin: 'Dir. Balmyrzon M. Valdez' },
    { id: 'R4A',   name: 'CALABARZON',                 admin: 'Dir. Liza Abad' },
    { id: 'R4B',   name: 'MIMAROPA',                 admin: 'Dir. Baron Jose L. Lagran' },
    { id: 'R5',   name: 'Bicol Region',                 admin: 'Dir. Archie A. Grande' },
    { id: 'R6',   name: 'Western Visayas',                 admin: 'Dir. Esther B. Babalo' },
    { id: 'NIR',   name: 'Negros Island Region',                 admin: 'Dir. Niña Connie Dodd' },
    { id: 'R7',   name: 'Central Visayas',                 admin: 'Dir. Gamaliel B. Vicente, Jr.' },
    { id: 'R8',   name: 'Eastern Visayas',                 admin: 'Dir. Dan M. Navarro' },
    { id: 'R9',   name: 'Zamboanga Peninsula',                 admin: 'Dir. Alan T. Bacatan' },
    { id: 'R10',   name: 'Northern Mindanao',                 admin: 'Dir. Rafael Y. Abrogar' },
    { id: 'R11',   name: 'Davao Region',                 admin: 'Dir. Tarhata S. Mapandi' },
    { id: 'R12',   name: 'SOCCSKSARGEN',                 admin: 'Dir. Remegias G. Timonio' },
    { id: 'CAR',   name: 'Cordillera Administrative Region',                 admin: 'Dir. Glenn N. Murphy' },
    { id: 'CARAGA',   name: 'CARAGA',                 admin: 'Dir. florencio F. Sunico, Jr.' },
  ];
