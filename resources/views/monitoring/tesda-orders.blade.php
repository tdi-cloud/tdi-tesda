...
<x-monitoring-layout>
    ...
    <div class=" flex px-5 py-2 border-b border-slate-300 bg-slate-200 dark:bg-slate-800 dark:border-slate-600 gap-2">
        ...
        <a href="/programs/{{ $myprogram->id }}/tesda-order" class="btn-ghost bg-white  hover:bg-white dark:hover:bg-slate-600 btn btn-sm poppins-semibold rounded-2xl  shadow-none"><i class="fa-solid fa-file-lines text-indigo-600"></i> TESDA Order</a> 
        @endif
                ...
                response.forEach(order => {
                    ...
                    html += `
                        <div  class="hover:scale-[1.01] duration-500 shadow-lg hover:shadow-2xl mb-3 p-3 border rounded poppins-regular border-slate-300 text-sm rounded-2xl bg-white dark:bg-slate-800 dark:border-slate-600 flex gap-2 justify-between">
                            ...
                            <div onclick="viewTO(${order.id})" class=" flex items-center gap-2">
                                
                            <div class="min-w-10 min-h-10 flex justify-center items-center bg-indigo-300/50 rounded-2xl">
                                <i class="fa-solid fa-file-lines text-indigo-600 dark:text-indigo-200 text-2xl"></i>
                            </div>
