...
<x-monitoring-layout>
    ...
    <div class="TABS flex px-5 py-2 border-b border-slate-300 bg-slate-200 dark:bg-slate-800 dark:border-slate-600 gap-2">
        ...
        <a href="/programs/{{ $myprogram->id }}/requirements" class="btn-default bg-white dark:bg-slate-600  hover:bg-white dark:hover:bg-slate-600 btn btn-sm poppins-semibold rounded-2xl  shadow-none"><i class="fa-regular fa-file"></i> Requirements</a>  
