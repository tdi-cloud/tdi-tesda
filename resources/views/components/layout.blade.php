...
<body class="min-h-screen flex flex-col bg-slate-100 dark:bg-slate-800/50">
    ...
    @auth
        ...
        <nav class="navbar  bg-white dark:bg-slate-900/50 px-10 border-b border-slate-300 dark:border-slate-600 sticky top-0">

            <div class="navbar-start gap-2">
                <a href="/"><img class="w-10 rounded-lg" src="{{ asset('images/TDI.png') }}" alt=""></a>
                <h1 class="poppins-bold text-sky-700 dark:text-white text-sm">TESDA Development Institute</h1>
            </div>

            <div class="navbar-center gap-4">
                <a href="/" class="hidden text-slate-900 dark:text-white poppins-regular text-[12px] cursor-default"><i
                        class="fa-regular fa-house"></i> Home</a>
    ...
    @if (session('success'))
        <div class="toast">
            <div class="alert alert-success">
                <span class="text-[12px] poppins-regular"><i class="fa-solid fa-hands-clapping"></i>
    ...
    <script>
        function toggleTheme() {
            ...
            html.setAttribute('data-theme', next); // DaisyUI
            html.classList.toggle('dark', next === 'dark'); // Tailwind dark:
